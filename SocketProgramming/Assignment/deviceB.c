...
int main() {
    ...
    strcpy(table[0].destination, "192.168.0.0");
    strcpy(table[0].netmask,    "255.255.255.0");
    strcpy(table[0].gateway,    "0.0.0.0");
    strcpy(table[0].interface,  "Eth0");
    table[0].metric = 1;

    strcpy(table[1].destination, "10.0.0.0");
    strcpy(table[1].netmask,    "255.0.0.0");
    strcpy(table[1].gateway,    "0.0.0.0");
    strcpy(table[1].interface,  "Eth1");
    table[1].metric = 1;

    strcpy(table[2].destination, "127.0.0.0");
    strcpy(table[2].netmask,    "255.255.255.0");
    strcpy(table[2].gateway,    "0.0.0.0");
    strcpy(table[2].interface,  "Eth2");
    table[2].metric = 1;
